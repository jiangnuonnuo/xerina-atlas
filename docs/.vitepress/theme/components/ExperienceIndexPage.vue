...
import ExperienceVisual from './ExperienceVisual.vue'
  ...
  <main class="page page-experience is-active">
    <div class="container page-container">
      ...
      <div class="timeline-list">
        <a v-for="(item, index) in experiences" :key="item.slug" class="timeline-link" :href="url(item.url)">
          <div class="timeline-content">
            <ExperienceVisual :kind="item.frontmatter.visual" :icon="item.frontmatter.icon" :index="index" />
