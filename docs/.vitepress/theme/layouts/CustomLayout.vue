...
<template>
  <div v-if="layout === 'home-custom'" class="atlas-site"><SiteHeader /><HomePage /><SiteFooter /></div>
  <div v-else-if="layout === 'projects-index'" class="atlas-site"><SiteHeader /><ProjectIndexPage /><SiteFooter /></div>
