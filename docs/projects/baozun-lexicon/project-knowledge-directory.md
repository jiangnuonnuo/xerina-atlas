...
**70 · 从一句周报到受治理 SQL**：谁调用引擎、周报如何拆章、未覆盖如何回退 `get_schema`。

**80 · SQL 安全边界、正确性验证与面试追问**：只读闸门、结果信封、Golden Query、正式报表生命周期。

### 不占三层

**55 · 治理型语义层与日报周报查询架构**：面试 90 秒口播，讲职责拆分。正文按 50–51、60–62、70–80 读。
